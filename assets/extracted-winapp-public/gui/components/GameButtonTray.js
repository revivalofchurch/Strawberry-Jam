    ...
    constructor() {
      ...
      this.attachShadow({mode: "open"}).innerHTML = `
        <style>
          ...
          /* When the host is NOT expanded (i.e., tray is collapsed/hidden) */
          :host(:not(.expanded)) #buttons-tray-container {
            display: none !important; /* Ensure this overrides .spaced-column's display:flex */
          }

          /* Ensure #buttons-tray-container is flex when expanded. */
          :host(.expanded) #buttons-tray-container {
            display: flex;
          }
          ...
          #expand-tray.hidden {
            /* left: 0%; */ /* Original rule, replacing with display:none for proper hiding */
            display: none !important; /* Ensure it's truly hidden */
          }
